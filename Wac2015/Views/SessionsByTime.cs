...
{
    public class SessionsByTime : TabbedPage
    {
        public SessionsByTime()
        {
            Title = "Sessions";
            ...
            dayOneSessions.SetBinding<MainViewModel>(ListView.ItemsSourceProperty, s => s.TimeBasedCollection);
