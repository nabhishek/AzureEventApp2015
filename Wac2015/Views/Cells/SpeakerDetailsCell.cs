...
{
    public class SpeakerDetailsCell : ViewCell
    {
        public SpeakerDetailsCell()
        {
            ...
            var twitter = App.CurrentSpeaker.TwitterHandle;
            

            if (String.IsNullOrEmpty(twitter))
                twitter = "$$#Azure4Sure|" + App.CurrentSpeaker.TwitterLink + "$$";
            else
                twitter = "$$" + twitter + "|" + App.CurrentSpeaker.TwitterLink + "$$";

            var twitterLink = new LinkLabel
            {
                VerticalOptions = LayoutOptions.Center,
                Font = Device.OnPlatform(Font.OfSize("HelveticaNeue-Light", NamedSize.Small),
                    Font.SystemFontOfSize(NamedSize.Large),
            ...
            var twitterStack = new StackLayout
            {
                Orientation = StackOrientation.Horizontal,
                HorizontalOptions = LayoutOptions.FillAndExpand,
                VerticalOptions = LayoutOptions.FillAndExpand,
                ...
                Spacing = 5,
                BackgroundColor = Color.Transparent,
                Children = { twitterImage, twitterLink }
            };
            ...
            var resultStack = new StackLayout
            {
                ...
                VerticalOptions = LayoutOptions.FillAndExpand,
                Spacing = 15,
                Children = { stack, twitterStack, aboutSpeaker },
                BackgroundColor = Color.Transparent
            };
