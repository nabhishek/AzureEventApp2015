<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sessionfeedback.aspx.cs" Inherits="FutureUnleashed_FeedbackWeb.sessionfeedback" %>
...
<head>
    ...
    <title>Future Unleashed 2015 </title>
...
<body onpageshow="getqueryString()">
        ...
        <form class="form-horizontal" id="add-item" style='font-family: "Segoe UI";'
            ...
            <div class="form-group" style='font-family: "Segoe UI";'>
                <div class="col-sm-12" style="text-align: center;">
                    ...
                    <!--<button id="feedbackbtn" style="width:150px" type="submit" >Submit</button>-->
                </div>
            ...
            <div class="col-sm-8">
                <p id="result"
                   style='font-family: "Segoe UI"; font-size: 20px;'></p>
            </div><br><br>
            <div class="container">
    ...
    <script src="sessionfeedback.js"></script>
</body>
</html>
