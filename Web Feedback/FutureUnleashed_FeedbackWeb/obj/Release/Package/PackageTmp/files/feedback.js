$(function () {
    var i = true;
    var client = new WindowsAzure.MobileServiceClient('https://testforconference.azure-mobile.net/', 'mhlLfCoQflviTJtQaoNPtmfEsyaosV69'),
    ...
    $('#add-item').submit(function (evt) {
        try {
            ...
            if (i == true) {
                ...
                if (itemText1 == undefined || itemText2 == undefined || itemText5 == undefined) {
                    return;
                }
    ...
    function refreshTodoItems() {
        document.getElementById("result").innerHTML = "Thanks! Your valuable feedback has been successfully recorded.";
