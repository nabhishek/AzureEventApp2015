$(function () {
    var i = true;
    // Change this to your Mobile Service Client connection 
    var client = new WindowsAzure.MobileServiceClient('https://futureunleashed.azure-mobile.net/', 'kaafHWyhvDMppcwXPlbBQKYGsBg62'),
